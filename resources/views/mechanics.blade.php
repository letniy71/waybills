...
<main>
    ...
    <h6 style="margin-bottom: 20px;">Механики</h6>
	<table>
		<thead>
		<tr>
			<th>ФИО</th>
      ...
      <tbody><tr>
  			<td data-label="ФИО">{{$row->nameMechanic}}</td>
  			<td data-label="Бригада">{{$row->brigade->nameBrigade}}</td>
  			<td data-label="Удалить">
          <form action="{{route('delete-mechanics')}}" method="post">
            <input type="hidden"  name="idMechanics" value="{{$row->idMechanics}}">
            ...
            <div class="styled-select">
              <div class="select">
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="select">
                      <select name="name_brigade_mechanics">
